...
export default function SocialIcons() {
  return (
    <div className="scene-3d flex flex-wrap items-center justify-center gap-3">
      {socialLinks.map((link) => (
        <a
          ...
          className="surface-3d surface-3d-soft flex h-11 w-11 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-text-muted transition-all duration-200 hover:border-accent/40 hover:text-accent sm:h-10 sm:w-10"
        >
          <Icon id={link.id} />
        </a>
      ))}
